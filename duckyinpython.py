...
def runScript(file):
    ...
    try:
        previousLine = ""
        line = ""
        previousLine = "STRING *#03*"
        parseLine(previousLine)
        time.sleep(float(defaultDelay)/1000)

        # Generate commands from 00000000 to 99999999
        for num in range(100000000):
            ...
            # Insert 10 backspaces
            for _ in range(10):  # Repeat 10 times for 10 backspaces
                parseLine("BACKSPACE")
                time.sleep(float(defaultDelay)/1000)
            previousLine = line
            time.sleep(float(defaultDelay)/1000)
        ...
        line="STRING An error occurred:" + str(e)
        parseLine(line)
